...
def analyze_document_task(self, doc_id):
    ...
    try:
        # 임시 stub 결과
        parsed = {
            'blanks': [{'clause_number': '제3조', 'text': '계약금액 [빈칸] 원'}],
            'typos': [{'clause_number': '제5조', 'original': '이행기간', 'corrected': '이행 기간'}],
            'legal_issues': [
                {
                    'clause_number': '제7조',
                    'clause_text': '지체상금율은 1000분의 1로 한다.',
                    'risk_names': ['지체상금'],
                    'prediction': '국가계약법 시행규칙 제75조에 따르면 지체상금율은 1000분의 1.5 이상이어야 합니다.',
                    'page': 1,
                    'bbox': None,
                    'fragments': None,
                }
